//#define AA 2
//#define VAPORWAVE
//#define stereo 0.5 // -1. for cross-eyed (defaults to parallel view)
#define speed 0.1 
//#define wave_thing
#define city
...
// WebGL 1.0 doesn't have round(), so we define it
#define round(x) floor((x) + 0.5)

// Always disable texture sampling since we don't have iChannel0
